...
@Component({
  selector: "app-atividade-coletiva-list",
  templateUrl: "./atividade-coletiva-list.page.html",
  styleUrls: ["./atividade-coletiva-list.page.scss"],
})
export class AtividadeColetivaListPage implements OnInit {
  ...
  newAtividadeColetiva() {
    this.navCtrl.navigateRoot("/atividade-coletiva-form");
  }
