...
@Component({
  selector: 'app-compromisso-nao-cumprido',
  templateUrl: './compromisso-nao-cumprido.page.html',
  styleUrls: ['./compromisso-nao-cumprido.page.scss'],
})
export class CompromissoNaoCumpridoPage implements OnInit {
