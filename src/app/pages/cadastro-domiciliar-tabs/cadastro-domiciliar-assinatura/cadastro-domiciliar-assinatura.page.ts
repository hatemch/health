...
@Component({
  selector: 'app-cadastro-domiciliar-assinatura',
  templateUrl: './cadastro-domiciliar-assinatura.page.html',
  styleUrls: ['./cadastro-domiciliar-assinatura.page.scss'],
})
export class CadastroDomiciliarAssinaturaPage implements OnInit {
  ...
  public subtitle = 'Cadastro Domiciliar';
  isDrawing = false;
  ...
  public collection: CadastroDomiciliarFoto[];
  ...
  ngOnInit() {
    this.activatedRoute.params.subscribe((res) => {
      ...
      //Online
      this.CRUDCadastroDomiciliarFotos('spCRUDCadastroDomiciliarFoto', 'READ', { cadastro_domiciliar: this.model.cadastro_domiciliar, tipo: this.model.tipo});
    });
    this.podesalvar = false;
  }
            ...
            alert.buttons = [
              {
                ...
                text: 'Sim',
                handler: () => {
                  this.CRUDCadastroDomiciliarFotos('spCRUDCadastroDomiciliarFoto', 'UPDATE', {
                    cadastro_domiciliar: this.model.cadastro_domiciliar,
    ...
    alert.buttons = [
      {
        ...
        text: 'Confirmar',
        handler: () => {
          this.CRUDCadastroDomiciliarFotos('spCRUDCadastroDomiciliarFoto', 'DELETE', {codigo: item.codigo, cadastro_domiciliar: item.cadastro_domiciliar});
